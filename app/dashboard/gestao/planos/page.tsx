...
const EnrollmentListPage = () => {
              ...
              <Link href={`/dashboard/gestao/planos/${enr.slug}`} className="block">
                <div className="border p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow bg-white">
                  ...
                  <div className="space-y-1">
                    ...
                    <p>
                      <strong>Data Final:</strong> {formatDate(enr.endDate)}
                    </p>
                    <p>
  ...
  return (
    <div className="space-y-12 p-8">
      <EnrollmentGroup title="Próximos Cursos" enrollments={upcomingEnrollments} />
      <EnrollmentGroup title="Cursos a Decorrer" enrollments={ongoingEnrollments} />
      <EnrollmentGroup title="Cursos Finalizados" enrollments={pastEnrollments} />
    </div>
  )
}
